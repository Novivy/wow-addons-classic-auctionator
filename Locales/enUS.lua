AUCTIONATOR_LOCALES.enUS = function()
  ...
  L["SPLASH_5001_DESCRIPTION"] = "Bug fixes for vanilla Classic private servers."
  L["SPLASH_5001_FIXES_HEADER"] = "Bug Fixes"
  L["SPLASH_5001_FIXES_1"] = "Herbs and other items returning an invalid class ID from the server now correctly appear in the selling tab."
  L["SPLASH_5001_FIXES_2"] = "Items whose data has not yet loaded when the selling tab opens are now shown once the data arrives."

  L["SPLASH_5000_DESCRIPTION"] = "Initial release for vanilla Classic private servers."
  L["SPLASH_5000_FIXES_HEADER"] = "Bug Fixes"
  L["SPLASH_5000_FIXES_1"] = "Fix full scan."
  L["SPLASH_5000_FIXES_2"] = "Fix duration display to use server data."
  L["SPLASH_5000_FIXES_3"] = "Fix deposit amount display to use server data."
  L["SPLASH_5000_FIXES_4"] = "Clear throttle immediately on multisell complete instead of waiting for NEW_AUCTION_UPDATE."
